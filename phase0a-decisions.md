...
>
> **상태: 전부 확정 (2026-08-31, 사용자 승인).** A1~A5·A7은 권고안대로, A6은 v4 인용에서 재구성(`squiz-core.md`)으로 확정. 설계 문서 D39~D41에 기록, 두 설계 문서에 반영 완료. 이하 원문은 결정 근거 보존용.
...
- [x] ~~v3 원문 확보~~ → 사용자 결정: v4 문서의 인용에서 **재구성**. `squiz-core.md`로 작성, 재구성임을 명시(추후 v3 원문 확보 시 대조).
- [x] 인라인 완료 (`squiz-core.md`)
